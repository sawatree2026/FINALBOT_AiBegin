...
from data_feed.strategies_mode.bridge_adapter.abstract_class import IDataSource
from data_feed.strategies_mode.bridge_adapter.bridge_iq_adapter.bridge_iq_adapter import IQOptionAdapter
from data_feed.strategies_mode.bridge_adapter.bridge_quotex_adapter.bridge_quotex_adapter import QuotexAdapter
from data_feed.strategies_mode.bridge_adapter.bridge_pocket_adapter.bridge_pocket_adapter import PocketAdapter
...
class BrokerFactory:
    ...
    def create_broker(config: Dict[str, Any]) -> Any:
        ...
        from data_feed.strategies_mode.csv_time_sync import TimeSyncManager
