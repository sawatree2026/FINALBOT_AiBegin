...
class MoneyManager:
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        trade_cfg = self.settings.get("data_trade", {}) if isinstance(self.settings, dict) else {}
        default_file = os.path.join("data_base", "output_trade", "trades_history.csv")
        raw_path = trade_cfg.get("trade_history_file", default_file)
        self.trade_history_file: str = os.path.normpath(raw_path) if raw_path else default_file
            ...
            with open(self.trade_history_file, "r", encoding="utf-8") as f:
                ...
                for line in f:
                    ...
                    if "," in line_str:
                        ...
                        # Skip header if any legacy file exists
                        ...
                        if rest.startswith("[") and rest.endswith("]"):
                            # Template bracketed format: [payload_id]:[order_id]:[symbol]:[action]:[expiry]:[stake]:[result]:[profit]:[balance]
                        ...
                        if ts.startswith(today_str):
                            ...
                            if result_status == "LOSE":
                                ...
                                try:
                                    ...
                                    parsed_dt = datetime.now(tz_thailand)
    ...
    def can_trade(self, symbol: str = "", balance: Optional[float] = None) -> Tuple[bool, str]:
        """
